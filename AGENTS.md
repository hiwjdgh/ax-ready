...
- `references/`: 필요할 때만 읽는 상세 readiness 기준.
...
- `.github/workflows/npm-publish.yml`: GitHub Release 기반 npm publish.
...
변경 후 `SKILL.md`, `references/`, `assets/templates/`, `memory/`가 서로 모순되지 않는지 확인한다.
